...
public interface AromaRepository extends JpaRepository<Aroma, Integer> {
    ...
    @Query("select new com.hanium.showerendorphins.dto.UserStoredAromaListDto(a.id, a.koName, a.enName, a.imgURL) from Aroma a")
    List<UserStoredAromaListDto> findAllAromaModifyList();
